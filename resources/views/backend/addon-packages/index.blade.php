    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ route('app.addon-packages.create') }}" class="btn-shadow mr-3 btn btn-primary">
                        ...
                        <tbody>
                            ...
                            @foreach ($addon_packages as $key => $addon_package)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{-- <a href="{{ route('app.addon-packages.show', $addon_package->id) }}" id=""
                                            class="btn btn-info btn-sm">
                                            <i class="fas fa-eye "></i>
                                            Show
                                        </a> --}}
                                        <a href="{{ route('app.addon-packages.edit', $addon_package->id) }}" id=""
                                            class="btn btn-info btn-sm">
                                            ...
                                            <form id='delete-form-{{ $addon_package->id }}'
                                                action="{{ route('app.addon-packages.destroy', $addon_package->id) }}" method="post"
                                                class='d-none'>
                                                @csrf
                                                @method('delete')
                                            </form>
