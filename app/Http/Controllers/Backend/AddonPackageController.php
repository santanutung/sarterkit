...
class AddonPackageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.addon-packages.index', ['addon_packages' => $addon_packages]);
    }
    ...
    public function create()
    {
        ...
        return view('backend.addon-packages.from');
    }
    ...
    public function show(AddonPackage $addon_package)
    {
        ...
        return view('backend.addon-packages.show', ['AddonPackage' => $addon_package]);
    }
