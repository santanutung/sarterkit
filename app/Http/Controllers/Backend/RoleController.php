...
class RoleController extends Controller
{
    ...
    public function create()
    {
        ...
        $modules = Module::all();
        return view('backend.Role.from', ['modules' => $modules]);
    }
    ...
    public function store(Request $request)
    {
        ...
        notify()->success("Role created", "Success", "topRight");
    ...
    public function edit(Role $role)
    {
        ...
        $modules = Module::all();
        return view('backend.Role.from', ['role' => $role, 'modules' => $modules]);
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        notify()->success("Role updated", "Success", "topRight");
        return  redirect(route('app.roles.index'));
    }
